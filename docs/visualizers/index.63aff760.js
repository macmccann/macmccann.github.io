...
var _colorThemesJs = require("./colorThemes.js");
var _colorThemesJsDefault = parcelHelpers.interopDefault(_colorThemesJs);
var _optionsJs = require("./options.js");
var _optionsJsDefault = parcelHelpers.interopDefault(_optionsJs);
var _visualizerTs = require("./visualizer.ts");
var _visualizerTsDefault = parcelHelpers.interopDefault(_visualizerTs);
document.getElementById("audioFileInput").addEventListener("change", handleFileSelect, false);
/// Testing
let audioContext, analyser, source, bufferLength, canvas, gl, program, dataArray, buffer, visualizer;
let ended = false;
...
function initAudio(audioData) {
    ...
    audioContext.decodeAudioData(audioData, function(buffer) {
        ...
        visualizer = new (0, _visualizerTsDefault.default)(audioContext);
...
document.getElementById("colorThemeSelect").addEventListener("change", (event)=>{
    (0, _colorThemesJsDefault.default).setTheme(event.target.value);
});
document.getElementById("modeSelect").addEventListener("change", (event)=>{
    (0, _optionsJsDefault.default).setOption("visualizer", event.target.value);
});

},{"./colorThemes.js":"17Nuf","./options.js":"dTwCz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./visualizer.ts":"cOUfa"}],"17Nuf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class ColorThemes {
    static getTheme() {
        return COLOR_THEMES[(0, _optionsJsDefault.default).getOption("theme")];
    }
...
},{"./options.js":"dTwCz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dTwCz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Options {
    static init() {
        ...
        this.sideEffects = (key)=>{
            if (key === "theme") setThemeSideEffect(this.opts.theme);
            if (key === "visualizer") setVisualizerSideEffect(this.opts.visualizer);
        };
...
},{"./audioLevels.js":"9Goj8","./audioProcessor.js":"c2Ffz","./renderFuncs.js":"5932f","./options.js":"dTwCz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9Goj8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class AudioLevels {
    constructor(audio){
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./fft.js":"8S9Sq"}],"8S9Sq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class FFT {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5932f":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const RENDER_FUNCS = {
    bars: (audio, canvas, ctx)=>{
        ...
        for(let i = 0; i < numBars; i++){
            ...
            ctx.fillStyle = (0, _colorThemesJsDefault.default).getTheme().primary;
    ...
    line: (audio, canvas, ctx)=>{
        ...
        ctx.strokeStyle = (0, _colorThemesJsDefault.default).getTheme().primary;
        ctx.lineWidth = 2;
        ctx.stroke();
    }
};

},{"./colorThemes.js":"17Nuf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6DoTH","adjPd"], "adjPd", "parcelRequire599b")
